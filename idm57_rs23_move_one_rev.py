"""
iDM57-RS23 - Rotate exactly one revolution, safely
----------------------------------------------------
This builds on the earlier status-check script. It will NOT move the motor
if a fault is active or the drive is disabled.

Install dependency first:
    pip install pymodbus

Run:
    python idm57_rs23_move_one_rev.py
"""
...
# ---------------------------------------------------------------------------
# Registers - confirmed directly from the iDM-RS series manual
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Move parameters - conservative values for a first-ever test
# ---------------------------------------------------------------------------
PULSES_PER_REV = 10000         # Pr0.00 default - confirm this matches your
                               # drive's actual setting before running
TEST_VELOCITY_RPM = 30         # deliberately slow for a first test
